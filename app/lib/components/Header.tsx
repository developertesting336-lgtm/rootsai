  ...
  return (
    <>
      <header className={styles.header}>
        ...
        <button className={styles.button} disabled>Start Assessment</button>
      ...
      {mobileMenuOpen && (
        <div className={styles.mobileMenu}>
          ...
          <nav className={styles.mobileNav}>
            ...
            <Link href="/platform" onClick={() => setMobileMenuOpen(false)}>Platform</Link>
            <Link href="/example-report" onClick={() => setMobileMenuOpen(false)}>Example Report</Link>
